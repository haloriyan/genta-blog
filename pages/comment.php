...
<head>
	...
	<title>Comments | Agendakota</title>
...
<div class="kiri">
	...
	<div class="wrap">
		...
		<a href="#"><li aktif='ya'><div class="icon"><i class="fas fa-comment"></i></div> <span>Comment</span></li></a>
...
<script>
	...
	function hapus(val) {
		let del = 'idcomment='+val
		pos("./comments/delete", del, () => {
			load()
		})
	}
	submit('#formHapus', () => {
